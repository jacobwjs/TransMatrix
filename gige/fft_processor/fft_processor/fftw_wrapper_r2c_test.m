% Demo script for the fftw_wrapper_r2c class.
%
...
f = fftw_wrapper_r2c(size(img,2),size(img,1));

% C++ transforms
ind_all  = mask_to_indices(true(size(img)),'fftshifted-to-fftw-r2c-transpose');
ind_mask = mask_to_indices(maskf,'fftshifted-to-fftw-r2c-transpose');
