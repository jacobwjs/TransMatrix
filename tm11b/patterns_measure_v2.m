function [experiments, speckle_ref] = patterns_measure_v2(vid, ...
                                                       slm, ...
                                                       camera_to_output, ...
                                                       camera_to_field, ...
                                                       experiments, ...
...
%     set(vid, 'TriggerRepeat', Inf);
    ...
    for i=1:numel(experiments)
        ...
        experiments(i).I_exposure = camera_exposure;
    ...
    speckle_ref.I_exposure = camera_exposure;
